-- Milestone 117: Starter sample content, batch 3 (PM, Lead Gen, Contracts,
-- Expenses, Quotations, HR, Recruitment, Knowledge Base)
--
-- Extends seed_starter_content() so new orgs get realistic demo data in
-- 8 more modules, bringing the total from 6 to 14 modules with starter content.
