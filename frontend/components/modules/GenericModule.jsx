...
const API_MAP = {
  ...
  'sms-marketing': '/api/v1/sms', 'inventory': '/api/v1/inventory',
  'pos': '/api/v1/pos', 'recruitment': '/api/v1/recruitment',
  ...
  'disputes': '/api/v1/disputes', 'communities': '/api/v1/communities',
  'events': '/api/v1/events', 'jobs': '/api/v1/jobs',
  'ideas': '/api/v1/ideas', 'skills': '/api/v1/skills',
  'ambassadors': '/api/v1/ambassadors', 'timezone-proposals': '/api/v1/timezone-proposals',
};
