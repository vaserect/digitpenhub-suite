...
export default function PaystackCheckout({ componentId, componentName, price, currency, onSuccess, onCancel }) {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mt-2">Please wait while we redirect you to Paystack</p>
        </div>
      </div>
      ...
      <div className="mt-4 text-center text-sm text-gray-600">
        <p>🔒 Secured by Paystack • Your payment information is protected</p>
      </div>
    </div>
  );
}
